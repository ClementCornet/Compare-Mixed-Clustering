...
#@numba.njit()
def huang_dist(x1, x2):
    cat1 = cat2 = num1 = num2 = []
    for a,b in zip(x1, x2):
        if np.issubdtype(type(a), np.number) and np.issubdtype(type(b), np.number):
            num1.append(a)
            num2.append(b)
        else:
            cat1.append(a)
            cat2.append(b)
    print(cat1, cat2, num1, num2)
...
if __name__ == '__main__':
    print("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAH")
    #huang_dist(
    #    ['A','B', 2, 3],
    #    ['A','A', 2, 1]
    #)